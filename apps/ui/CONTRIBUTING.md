...
Thank you for your interest in contributing to creantly ui! This guide will help you understand how to contribute components and particles to our design system.

## Overview

**creantly ui** consists of two main types of components:
...
// registry/registry-particles.ts
{
  ...
  name: "p-button-8",
  registryDependencies: ["@creantly/button"],
  type: "registry:block",
}
```
...
- `registryDependencies`: Array of UI components used (e.g., `["@creantly/button"]`, `["@creantly/input", "@creantly/label"]`)
...
- `registryDependencies` should reference `@creantly/*` package names
...
Thank you for contributing to creantly ui! 🎉
